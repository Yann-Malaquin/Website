...
--
-- Hôte : 127.0.0.1:3308
-- Généré le :  mer. 03 juin 2020 à 16:45
...
(2, 'LOSC Lille', 6, 'LOSC', 'football', 'LOSC.svg.png', 'Gérard Lopez', 'Christophe Galtier'),
(3, 'Valenciennes FC', 3, 'VAFC', 'football', 'VAFC.svg.png', 'Eddy Zdziech', 'Olivier Guégan'),
(5, 'Paris Saint Germain', 7, 'PSG', 'football', 'PSG.svg.png', 'Nasser al-Khelaïfi', 'Thomas Tuchel'),
(6, 'Olympique de Marseille', 9, 'OM', 'football', 'OM.svg.png', 'Frank McCourt', 'André Villas-Boas'),
(7, 'Stade Rennais FC', 10, 'SRFC', 'football', 'SRFC.svg.png', 'Nicolas Holveck', 'Julien Stéphan'),
(8, 'Union Bordeaux-Bègles', 11, 'UBB', 'rugby', 'UBB.svg.png', 'Laurent Marti', 'Christophe Urios'),
(9, 'Lyon OU', 12, 'LOU', 'rugby', 'LOU.svg.png', 'Yann Roubert', 'Pierre Mignoni'),
(10, 'Racing 92', 13, 'Racing', 'rugby', 'Racing.svg.png', 'Jacky Lorenzetti', 'Laurent Travers'),
(11, 'Rugby Club Toulonnais', 14, 'RCT', 'rugby', 'RCT.svg.png', 'Bernard Lemaître', 'Patrice Collazo'),
(12, 'Paris Saint-Germain Handball', 15, 'PSGH', 'handball', 'PSG.svg.png', 'Nasser al-Khelaïfi', 'Raul Gonzalez Gutiérrez'),
(13, 'Handball Club de Nantes', 16, 'Le H', 'handball', 'Le H.svg.png', 'Gaël Pelletier', 'Alberto Entrerrios'),
(14, 'USAM Nîmes Gard', 17, 'USAM', 'handball', 'USAM.svg.png', 'David Tebib', 'Frank Maurice'),
(15, 'Montpellier Handball', 18, 'MHB', 'handball', 'MHB.svg.png', 'Julien Deljarry', 'Patrice Canayer');
